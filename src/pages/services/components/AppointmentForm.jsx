                ...
                <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="col-span-2">
                        <label className="flex items-center text-gray-700 font-medium mb-2">
                            <FaUser className="mr-2 text-indigo-600" /> Elderly
                            Person's Name
                        </label>
                        <input
                            type="text"
                    ...
                    <div>
                        <label className="flex items-center text-gray-700 font-medium mb-2">
                            <FaPhone className="mr-2 text-indigo-600" /> Contact
                            Number
                        </label>
                        <input
                            type="tel"
                    ...
                    <div className="col-span-2">
                        <label className="flex items-center text-gray-700 font-medium mb-2">
                            <FaHeartbeat className="mr-2 text-red-600" /> Health
                            Issues
                        </label>
                        <textarea
                    ...
                    <div className="col-span-2">
                        <label className="flex items-center text-gray-700 font-medium mb-2">
                            <FaUtensils className="mr-2 text-yellow-600" /> Food
                            Preferences
                        </label>
                    ...
                    {/* Submit */}
                    <Link to="/terms" className="col-span-2">
                        <motion.button
                            type="button"
                            className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-6 rounded-xl shadow-lg transition-all"
